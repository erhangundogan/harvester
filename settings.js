module.exports = {
  ...
  "random_timer": true,
  "timer_min": 5, // seconds min time
  "timer_add_random": 30, // seconds min time + add random time
  ...
  "mongodb_collection" : "proxy_result", // mongodb collection to save
  ...
  "request_timeout" : 180000, // Integer containing the number of milliseconds to wait for a request to respond before aborting the request
  "body_includes" : "<title>wired.com", // use some text from webpage if you want to test results, use GET for method
